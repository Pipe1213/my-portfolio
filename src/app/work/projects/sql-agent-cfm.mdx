...
summary: "Developed a functional SQL Agent at Capital Fund Management (CFM) using LangChain and LangGraph, integrating hybrid retrieval and agentic reasoning to translate natural-language questions into accurate SQL queries. Achieved 88% accuracy and 93% correct table selection on internal datasets. Tech: Python, LangChain, LangGraph, Oracle SQL, Streamlit, ChromaDB, BM25, RRF"
images:
