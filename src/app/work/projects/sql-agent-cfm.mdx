---
title: "Data Analysis Agent for Enterprise Data at CFM"
publishedAt: "2025-09-01"
tags: ["LangGraph", "RAG", "Oracle", "Agents"]
links:
  - { label: "Overview", href: "/#contact" }   # or replace later with a public case study
summary: "Developed a Data Analysis Agent at Capital Fund Management (CFM) using LangChain and LangGraph, integrating hybrid retrieval and agentic reasoning to translate natural-language questions into accurate SQL queries. Achieved 88% accuracy and 93% correct table selection on internal datasets. Tech: Python, LangChain, LangGraph, Oracle SQL, Streamlit, ChromaDB, BM25, RRF"
images:
...
- Internal evaluation (co-designed with the data team) reached **88% answer accuracy**.
- Table selection achieved **93% correct retrieval**, driven by hybrid BM25 + embeddings with **RRF** fusion.
